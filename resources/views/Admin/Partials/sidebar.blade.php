    ...
    <nav class="navbar navbar-light">
        <a href="{{ url('/dashboard') }}" class="navbar-brand mx-4 mb-3">
            <h3 class="text-danger fw-bold">
                <i class="bi bi-fire me-2"></i>Seblak Admin
            </h3>
        </a>
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{ url('/orders') }}" class="nav-item nav-link {{ Request::is('orders*') ? 'active' : '' }}">
            ...
            <a href="{{ url('/laporan') }}" class="nav-item nav-link {{ Request::is('laporan*') ? 'active' : '' }}">
